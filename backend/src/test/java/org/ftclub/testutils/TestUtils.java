...
public class TestUtils {
    ...
    public static String getTestAdminToken(Key signingKey, Date now, String emailName, String emailDomain) {
    ...
    public static String getTestMasterToken(Key signingKey, Date now, String emailName, String emailDomain) {
        Map<String, Object> claim = new HashMap<>();
        claim.put("email", emailName + "@" + emailDomain);
    ...
    public static String getTestUserTokenByName(Key signingKey, Date now, Date blackholedAt, String name, String emailDomain) {
        Map<String, Object> claim = new HashMap<>();
        claim.put("name", name);
        claim.put("email", name + "@" + emailDomain);
        claim.put("blackholedAt", blackholedAt);

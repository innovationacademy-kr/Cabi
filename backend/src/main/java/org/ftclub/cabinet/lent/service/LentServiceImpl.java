...
public class LentServiceImpl implements LentService {
    private static final Logger logger = LogManager.getLogger(LentService.class);
    ...
    public void startLentCabinet(Long userId, Long cabinetId) {
        logger.info("Called startLentCabinet: {}, {}", userId, cabinetId);
        Date now = new Date();
    ...
    public void startLentClubCabinet(Long userId, Long cabinetId) {
        logger.info("Called startLentClubCabinet: {}, {}", userId, cabinetId);
        Date now = new Date();
    ...
    public void endLentCabinet(Long userId) {
        logger.info("Called endLentCabinet: {}", userId);
    ...
    public void terminateLentCabinet(Long userId) {
        logger.info("Called terminateLentCabinet: {}", userId);
        returnCabinet(userId);
    }

    @Override
    public void terminateLentByCabinetId(Long cabinetId) {
        logger.info("Called terminateLentByCabinetId: {}", cabinetId);
        returnCabinetByCabinetId(cabinetId);
    }

    private LentHistory returnCabinetByCabinetId(Long cabinetId) {
        logger.info("Called returnCabinetByCabinetId: {}", cabinetId);
        Date now = new Date();
        Cabinet cabinet = cabinetExceptionHandler.getCabinet(cabinetId);
        LentHistory lentHistory = lentOptionalFetcher.getActiveLentHistoryWithCabinetId(cabinetId);
    ...
    private LentHistory returnCabinet(Long userId) {
        logger.info("Called returnCabinet: {}", userId);
        Date now = new Date();
    ...
    public void assignLent(Long userId, Long cabinetId) {
        logger.info("Called assignLent: {}, {}", userId, cabinetId);

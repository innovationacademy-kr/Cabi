...
public interface BanPolicy {
	 ...
	 * @return 정지 유형을 반환합니다.
	 */
	BanType verifyForBanType(LentType lentType, LocalDateTime startAt, LocalDateTime endedAt, LocalDateTime expiredAt);
	 ...
	 */
	LocalDateTime getBanDate(BanType banType, LocalDateTime endedAt, LocalDateTime expiredAt, Long userId);
	 ...
	 */
	boolean checkAlreadyExpired(LocalDateTime endedAt, LocalDateTime expiredAt);
	 ...
	 */
	boolean isActiveBanHistory(LocalDateTime unbannedAt, LocalDateTime now);

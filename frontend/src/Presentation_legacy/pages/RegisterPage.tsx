...
import RegisterModal from "@/Presentation_legacy/components/Modals/RegisterModal/RegisterModal";
import DropdownDateMenu from "@/Presentation_legacy/components/Register/DropdownDateMenu";
import DropdownTimeMenu from "@/Presentation_legacy/components/Register/DropdownTimeMenu";
import InputField from "@/Presentation_legacy/components/Register/InputField";
import {
  PresentationCategoryTypeLabelMap,
  PresentationTimeMap,
} from "@/Presentation_legacy/assets/data/maps";
import { PresentationCategoryType } from "@/Presentation_legacy/types/enum/presentation.type.enum";
import { axiosGetPresentationAbleDates } from "@/Presentation_legacy/api/axios/axios.custom";
import useInput, { IValidationResult } from "@/Presentation_legacy/hooks/useInput";
import useInvalidDates from "@/Presentation_legacy/hooks/useInvalidDates";
import {
  MAX_CONTENT_LENGTH,
  MAX_SUMMARY_LENGTH,
  MAX_TITLE_LENGTH,
} from "@/Presentation_legacy/constants/policy";

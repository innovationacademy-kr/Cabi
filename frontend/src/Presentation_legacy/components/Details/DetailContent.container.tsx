...
import { isCurrentModalState } from "@/Presentation_legacy/recoil/atoms";
import DetailContent from "@/Presentation_legacy/components/Details/DetailContent";
...
import { FUTURE_MONTHS_TO_DISPLAY } from "@/Presentation_legacy/constants/policy";

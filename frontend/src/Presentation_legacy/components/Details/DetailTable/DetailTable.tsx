...
import DetailTableBodyItem from "@/Presentation_legacy/components/Details/DetailTable/DetailTableBodyItem";
import DetailTableHead from "@/Presentation_legacy/components/Details/DetailTable/DetailTableHead";

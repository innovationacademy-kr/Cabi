...
import AdminItemProvideTable from "@/Cabinet/components/ItemLog/ItemLogTable/AdminItemProvideTable";
import { IItemLog } from "@/Cabinet/types/dto/admin.dto";

const AdminItemProvideLog = ({
  closeItem,
  logs,
  page,
  totalPage,
  ...
  return (
    <AdminItemUsageLogStyled>
      <AdminItemProvideTable itemLog={logs} />
...
export default AdminItemProvideLog;

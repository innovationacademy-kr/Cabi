...
import { z } from "zod";
import { PresentationPeriodType } from "@/Presentation/types/enum/presentation.type.enum";
      ...
      render={({ field }) => (
        <FormItem>
          ...
          <Select onValueChange={field.onChange} defaultValue={field.value}>
            ...
            <SelectContent>
              <SelectItem value={PresentationTimeType.HALF}>
                {PresentationTimeType.HALF}
              </SelectItem>
              <SelectItem value={PresentationTimeType.HOUR}>
                {PresentationTimeType.HOUR}
              </SelectItem>
              <SelectItem value={PresentationTimeType.HOUR_HALF}>
                {PresentationTimeType.HOUR_HALF}
              </SelectItem>
            </SelectContent>
          </Select>
          {/* <FormMessage /> */}
